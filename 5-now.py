...
N>=15 (same bar as the GMM fit); a leading incomplete month is reported
unscored. The projection for the upcoming month is the calendar-table row
(shrunk P(Trend) + 95% CI).
...
def main() -> None:
    ...
    for r in pending:
        print(f"in progress (unscored): {r['ym']} N={r['n']}")
