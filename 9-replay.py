...
def main() -> None:
    ...
    for t in targets:
        ...
        stab.append(
            {"ym": t, "means": g.means_.copy(), "weights": g.weights_.copy(), "tidx": tidx}
        )
    ...
    ref_means, ref_w = ref_g.means_, ref_g.weights_
    ...
    print(f"STABILITY: {'PASS' if ok and worst < 0.05 else 'FAIL'} (max_drift={worst:.4f})")
